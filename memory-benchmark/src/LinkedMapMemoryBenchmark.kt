...
internal class KotlinLinkedMapMemoryBenchmark : Measurer {
  override fun measure(size: String, operations: Object2LongArrayMap<String>, blackhole: Blackhole) {
    val benchmark = KotlinxOrderedObjectToObjectBenchmark()
    addOperation("kotlin_get", operations, benchmark.get(setup(KotlinxOrderedObjectToObjectBenchmark.BenchmarkGetState(), size), blackhole))
