...
public class KotlinxOrderedObjectToObjectBenchmark implements ObjectBenchmark<KotlinxOrderedObjectToObjectBenchmark.BenchmarkGetState> {
  @State(Scope.Thread)
  public static class BenchmarkGetState extends BaseBenchmarkState {
    ...
    public void setup() throws Exception {
      ...
      this.keys = keys;
      this.map = mutate(persistentMapOf(), map -> {
  ...
  public Object put(BaseBenchmarkState.ObjectPutOrRemoveBenchmarkState state, Blackhole blackhole) {
    PersistentMap<ArbitraryPojo, ArbitraryPojo> map = persistentMapOf();
