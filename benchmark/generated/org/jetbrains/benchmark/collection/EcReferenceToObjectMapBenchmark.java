...
public class EcReferenceToObjectMapBenchmark implements ObjectBenchmark<EcReferenceToObjectMapBenchmark.BenchmarkGetState> {
  @State(Scope.Thread)
  ...
  @Benchmark
  public org.eclipse.collections.impl.map.strategy.mutable.UnifiedMapWithHashingStrategy<ArbitraryPojo, ArbitraryPojo> put(BaseBenchmarkState.ReferencePutOrRemoveBenchmarkState state, Blackhole blackhole) {
  ...
  @Benchmark
  public org.eclipse.collections.impl.map.strategy.mutable.UnifiedMapWithHashingStrategy<ArbitraryPojo, ArbitraryPojo> remove(BaseBenchmarkState.ReferencePutOrRemoveBenchmarkState state, Blackhole blackhole) {
    org.eclipse.collections.impl.map.strategy.mutable.UnifiedMapWithHashingStrategy<ArbitraryPojo, ArbitraryPojo> map = org.jetbrains.benchmark.collection.factory.EcFactory.createReferenceToObject(state.loadFactor);
    int add = 0;
    int remove = 0;
    ArbitraryPojo[] keys = state.keys;
